...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 27 mai 2020 à 23:08
...
INSERT INTO `joueurs` (`pseudo`, `mdp`, `avatar`, `voitureRouge`) VALUES
('Sarah', '74e56e87176ecb29990e089e27427df725e41394', 'horloge', '3X.L'),
('Flora', '6ea10336558246e3e323c6b2a4e48d27787a9edd', 'horloge', '2X.L'),
('Line', '9c0f6e9b754edc49ce0aebeca4d22289cc62b4ab', 'horloge', '1X.L'),
('Pauline', 'c4a6b689e378ed552f591d19d0c4f0580ad9e148', 'horloge', '4X.L');
...
--
-- Déchargement des données de la table `niveau_en_cours`
--

INSERT INTO `niveau_en_cours` (`idNiveau`, `difficulté`, `lettre_vehicule`, `taille_vehicule`, `coord_ligne`, `coord_colonne`, `orientation`) VALUES
(10, 'facile', 'A', 2, 2, 2, 'U'),
(10, 'facile', 'C', 2, 4, 4, 'L'),
(10, 'facile', 'D', 2, 5, 5, 'U'),
(10, 'facile', 'G', 2, 4, 2, 'L'),
